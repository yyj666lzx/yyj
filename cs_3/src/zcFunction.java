...
class zongcangFunction extends CardTemplateFrame implements InterfaceFunction , ActionListener {
    ...
    JButton pd=new JButton("盘点");
    TableOperate tableOperate = null;
    public zongcangFunction(){
        closable =true;
        setVisible(true);
